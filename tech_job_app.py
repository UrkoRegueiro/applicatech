...
def tech_app():
    ...
    col_2.markdown(
        '<p class="big-font">Esta plataforma es el resultado del trabajo en equipo llevado por Adrián Moldes, Eduardo Velazco, Esteban Pérez y Urko Regueiro como proyecto final del bootcamp de <span style="font-weight: bold; color: orange">Data Science e Inteligencia Artificial</span> de la escuela <span style="font-weight: bold; color: orange">HACK A BOSS</span>.<br>'
        ...
        'Por último hemos diseñado un <span style="font-weight: bold; color: orange">Predictor Salarial</span> montado sobre dos modelos de Machine Learning, que te permitirá, especificando ciertos parámetros, obtener un rango salarial estimado ajustado a tus características.<br><br>'
